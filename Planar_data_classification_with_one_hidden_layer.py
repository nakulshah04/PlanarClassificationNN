...
def forward_propagation(X, parameters):
    ...
    # YOUR CODE STARTS HERE
    Z1 = np.dot(W1, X) + b1
    A1 = np.tanh(Z1) # Because the first hidden layer has a tanh activation function
    Z2 = np.dot(W2, A1) + b2
    A2 = sigmoid(Z2) # Because the first hidden layer has a sigmoid activation function
    # YOUR CODE ENDS HERE
